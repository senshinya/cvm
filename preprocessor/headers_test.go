...
`, Options{})
	...
	for _, name := range []string{"FILE", "size_t", "stdin", "stdout", "stderr", "fputs", "fputs_unlocked", "fputc", "fputc_unlocked", "puts", "putchar", "getchar", "fflush", "fclose", "ferror", "clearerr", "feof", "fwrite", "fread", "fgetc", "ungetc", "fgets", "printf", "fprintf", "sprintf", "snprintf", "vprintf", "vfprintf", "vsprintf", "vsnprintf"} {
