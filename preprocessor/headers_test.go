...
`, Options{})
	...
	for _, name := range []string{"abs", "labs", "llabs", "atoi", "atol", "atoll", "atof", "strtol", "strtoul", "strtoll", "strtoull", "strtod", "strtof", "strtold", "malloc", "calloc", "realloc", "free", "strdup", "rand", "srand", "getenv", "exit", "abort"} {
		if !hasIdentifier(res.Tokens, name) {
