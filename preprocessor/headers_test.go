...
`, Options{})
	...
	for _, name := range []string{"size_t", "strcmp", "memcmp", "strncmp", "strlen", "strnlen", "strerror", "strchr", "strrchr", "strstr", "strpbrk", "strspn", "strcspn", "memchr", "memcpy", "memmove", "mempcpy", "memset", "bzero", "strcpy", "stpcpy", "strcat", "strncpy", "stpncpy", "strncat"} {
		if !hasIdentifier(res.Tokens, name) {
