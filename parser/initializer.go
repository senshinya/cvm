...
func ParseInitializer(root *glr.RawAstNode) (*entity.Initializer, error) {
...
func ParseInitializerList(listNode *glr.RawAstNode) ([]*entity.InitializerItem, error) {
...
func ParseDesignation(root *glr.RawAstNode) ([]*entity.Designator, error) {
