...
- Latest implementation/coverage commit before this handoff document: `e4f3a55 feat(runtime): support printf width flags`
...
- `e4f3a55 feat(runtime): support printf width flags`
  ...
  - Keeps precision handling explicit as unsupported.
