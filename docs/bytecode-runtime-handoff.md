...
- Latest implementation/coverage commit before this handoff document: `f27d944 test(runtime): execute GCC inline volatile calls`
...
Inline runtime coverage includes repeated inline calls with volatile global side effects from `pr71969-1.c`.
