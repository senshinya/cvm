...
| path | error |
| --- | --- |
| `sema/testdata/gcc-c99/accept/c99-bool-4.c` | `runtime load error: unresolved extern strcmp` |
| `sema/testdata/gcc-c99/accept/c99-digraph-1.c` | `runtime load error: unresolved extern strcmp` |
| `sema/testdata/gcc-c99/accept/c99-func-1.c` | `runtime load error: unresolved extern strcmp` |
| `sema/testdata/gcc-c99/accept/c99-hexfloat-2.c` | `runtime load error: unresolved extern strcmp` |
