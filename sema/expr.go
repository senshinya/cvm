...
func tgmathArityOK(name string, argc int) bool {
	switch name {
	case "__cvm_tgmath_pow", "__cvm_tgmath_atan2", "__cvm_tgmath_hypot", "__cvm_tgmath_fdim", "__cvm_tgmath_fmax", "__cvm_tgmath_fmin", "__cvm_tgmath_fmod", "__cvm_tgmath_remainder":
		return argc == 2
	default:
		return argc == 1
	}
