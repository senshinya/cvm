...
func (s *Sema) tgmathReturnType(name string, args []Expr) Type {
	if (name == "__cvm_tgmath_fabs" || name == "__cvm_tgmath_cimag" || name == "__cvm_tgmath_creal") && len(args) > 0 {
